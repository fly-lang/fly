//===--------------------------------------------------------------------------------------------------------------===//
// include/Basic/SourceManagerInternals.h - source manager internal data structures
//
...
#ifndef LLVM_FLY_BASIC_SOURCEMANAGERINTERNALS_H
#define LLVM_FLY_BASIC_SOURCEMANAGERINTERNALS_H
