//===--------------------------------------------------------------------------------------------------------------===//
// include/Basic/DiagnosticIDs.h - diagnostic IDs and categories
//
...
#ifndef LLVM_FLY_BASIC_DIAGNOSTICIDS_H
#define LLVM_FLY_BASIC_DIAGNOSTICIDS_H
...
namespace fly {
  ...
  namespace diag {
    ...
    enum {
      DIAG_START_COMMON        =                          0,
      DIAG_UPPER_LIMIT         = DIAG_SIZE_COMMON
    };
