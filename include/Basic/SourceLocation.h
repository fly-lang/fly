//===--------------------------------------------------------------------------------------------------------------===//
// include/Basic/SourceLocation.h - Compact identifier for Source Files
//
...
#ifndef LLVM_FLY_BASIC_SOURCELOCATION_H
#define LLVM_FLY_BASIC_SOURCELOCATION_H
...
/// to getDouble at the full include stack, line and column information.
///
...
///
/// You can getDouble a PresumedLoc from a SourceLocation with SourceManager.
class PresumedLoc {
...
namespace llvm {
  ...
  /// DenseSets.
  template <>
  struct DenseMapInfo<fly::FileID> {
    static fly::FileID getEmptyKey() {
      return {};
    }

    static fly::FileID getTombstoneKey() {
      return fly::FileID::getSentinel();
    }

    static unsigned getHashValue(fly::FileID S) {
      return S.getHashValue();
    }

    static bool isEqual(fly::FileID LHS, fly::FileID RHS) {
      return LHS == RHS;
    }
  };
  ...
  struct PointerLikeTypeTraits<fly::SourceLocation> {
    ...
    static fly::SourceLocation getFromVoidPointer(void *P) {
      return fly::SourceLocation::getFromRawEncoding((unsigned)(uintptr_t)P);
    }
  };

} // namespace llvm

#endif // LLVM_FLY_BASIC_SOURCELOCATION_H
