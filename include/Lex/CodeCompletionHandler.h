//===----------------------------------------------------------------------===//
// Lex/CodeCompletionHandler.h - Preprocessor code completion
//
...
//
//===----------------------------------------------------------------------===//
#ifndef LLVM_FLY_LEX_CODECOMPLETIONHANDLER_H
#define LLVM_FLY_LEX_CODECOMPLETIONHANDLER_H
...
#endif // LLVM_FLY_LEX_CODECOMPLETIONHANDLER_H
