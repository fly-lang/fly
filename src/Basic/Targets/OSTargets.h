...
#ifndef FLY_LIB_BASIC_TARGETS_OSTARGETS_H
#define FLY_LIB_BASIC_TARGETS_OSTARGETS_H
...
// FreeBSD Target
template <typename Target>
class LLVM_LIBRARY_VISIBILITY FreeBSDTargetInfo : public OSTargetInfo<Target> {protected:
...
#endif // FLY_LIB_BASIC_TARGETS_OSTARGETS_H
