...
//===--------------------------------------------------------------------------------------------------------------===//
// compiler/Basic/Stack.cpp - stack space utilities
//
...
void fly::noteBottomOfStack() {
  if (!BottomOfStack)
    BottomOfStack = getStackPointer();
}

bool fly::isStackNearlyExhausted() {
...
void fly::runWithSufficientStackSpaceSlow(llvm::function_ref<void()> Diag,
