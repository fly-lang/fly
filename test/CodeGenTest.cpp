...
namespace {
    ...
    TEST_F(CodeGenTest, CGFuncUseGlobalVar) {
        ...
        EXPECT_TRUE(Builder->AddExpr(VarAAssign,
                                     Builder->CreateExpr(VarA, SemaBuilder::CreateIntegerValue(SourceLoc, 1))));
        ...
        EXPECT_TRUE(Builder->AddExpr(GVarAssign,
                                     Builder->CreateExpr(VarA, SemaBuilder::CreateFloatingValue(SourceLoc, 1))));
        EXPECT_TRUE(Builder->AddStmt(MainFn, GVarAssign));

        // return A
        ASTReturn *Return = Builder->CreateReturn(SourceLoc);
        EXPECT_TRUE(Builder->AddExpr(Return,
    ...
    TEST_F(CodeGenTest, CGArithOp) {
        ...
        EXPECT_TRUE(Builder->AddExpr(aVarAssign,
        ...
        EXPECT_TRUE(Builder->AddExpr(bVarAssign,
        ...
        EXPECT_TRUE(Builder->AddExpr(cAddVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_ADD,
        ...
        EXPECT_TRUE(Builder->AddExpr(cSubVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_SUB,
        ...
        EXPECT_TRUE(Builder->AddExpr(cMulVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_MUL,
        ...
        EXPECT_TRUE(Builder->AddExpr(cDivVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_DIV,
        ...
        EXPECT_TRUE(Builder->AddExpr(cModVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_MOD,
        ...
        EXPECT_TRUE(Builder->AddExpr(cAndVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_AND,
        ...
        EXPECT_TRUE(Builder->AddExpr(cOrVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_OR,
        ...
        EXPECT_TRUE(Builder->AddExpr(cXorVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_XOR,
        ...
        EXPECT_TRUE(Builder->AddExpr(cShlVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_SHIFT_L,
        ...
        EXPECT_TRUE(Builder->AddExpr(cShrVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc,ARITH_SHIFT_R,
        ...
        EXPECT_TRUE(Builder->AddExpr(cPreIncVarAssign,
                                     Builder->CreateUnaryExpr(SourceLoc,ARITH_INCR, UNARY_PRE,
        ...
        EXPECT_TRUE(Builder->AddExpr(cPostIncVarAssign,
                                     Builder->CreateUnaryExpr(SourceLoc,ARITH_INCR, UNARY_POST,
        ...
        EXPECT_TRUE(Builder->AddExpr(cPreDecVarAssign,
                                     Builder->CreateUnaryExpr(SourceLoc, ARITH_DECR, UNARY_PRE,
        ...
        EXPECT_TRUE(Builder->AddExpr(cPostDecVarAssign,
                                     Builder->CreateUnaryExpr(SourceLoc, ARITH_DECR, UNARY_POST,
    ...
    TEST_F(CodeGenTest, CGComparatorOp) {
        ...
        EXPECT_TRUE(Builder->AddExpr(cEqVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, COMP_EQ,
        ...
        EXPECT_TRUE(Builder->AddExpr(cNeqVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, COMP_NE,
        ...
        EXPECT_TRUE(Builder->AddExpr(cGtVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, COMP_GT,
        ...
        EXPECT_TRUE(Builder->AddExpr(cGteVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, COMP_GTE,
        ...
        EXPECT_TRUE(Builder->AddExpr(cLtVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, COMP_LT,
        ...
        EXPECT_TRUE(Builder->AddExpr(cLteVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, COMP_LTE,
    ...
    TEST_F(CodeGenTest, CGLogicOp) {
        ...
        EXPECT_TRUE(Builder->AddExpr(cAndVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, LOGIC_AND,
        ...
        EXPECT_TRUE(Builder->AddExpr(cOrVarAssign,
                                     Builder->CreateBinaryExpr(SourceLoc, LOGIC_OR,
    ...
    TEST_F(CodeGenTest, CGTernaryOp) {
        ...
        // return
        ASTVarAssign * cOrVarAssign = Builder->CreateVarAssign(Builder->CreateVarRef(cVar));
        ASTBinaryGroupExpr *Cond = Builder->CreateBinaryExpr(SourceLoc, COMP_EQ,
                                                             Builder->CreateExpr(cOrVarAssign,
                                                                                 Builder->CreateVarRef(aVar)),
                                                             Builder->CreateExpr(cOrVarAssign,
                                                                                 Builder->CreateVarRef(bVar)));
        EXPECT_TRUE(Builder->AddExpr(cOrVarAssign,Builder->CreateTernaryExpr(SourceLoc, Cond,
                                                                             Builder->CreateExpr(cOrVarAssign,
                                                                                                 Builder->CreateVarRef(aVar)),
                                                                             Builder->CreateExpr(cOrVarAssign,
                                                                                                 Builder->CreateVarRef(bVar)))));
...
//        ASTBinaryGroupExpr *Cond = Builder->CreateBinaryExpr(SourceLoc, COMP_EQ, aVarRef, Value1);
//        EXPECT_TRUE(Builder->AddExpr(IfBlock, Cond));
//
//        // if (a == 1) { a = 2 }
//        ASTVarAssign *aVarAssign = Builder->CreateVarAssign(Builder->CreateVarRef(aVar));
//        EXPECT_TRUE(Builder->AddExpr(aVarAssign,
