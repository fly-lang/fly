...
namespace {
	...
	TEST_F(CodeGenTest, CGInterfaceExtendsInterfaces) {
    	...
    	EXPECT_EQ(output, "\n%error = type { i32, ptr, ptr }\n"
    	                  ...
    	                  "@vtable.TestClass.BaseInterface2 = constant [2 x ptr] [ptr inttoptr (i64 -24 to ptr), ptr @thunk.TestClass.BaseInterface2.undo.1]\n"
    	                  "\n"
    	                  ...
    	                  "  store ptr @vtable.TestClass.TestInterface, ptr %4, align 8\n"
    	                  "  %5 = getelementptr i8, ptr %2, i64 16\n"
    	                  "  store ptr @vtable.TestClass.BaseInterface, ptr %5, align 8\n"
    	                  "  %6 = getelementptr i8, ptr %2, i64 24\n"
    	                  "  store ptr @vtable.TestClass.BaseInterface2, ptr %6, align 8\n"
    	                  "  ret ptr %2\n"
    	                  "}\n"
    	                  "\n"
    	                  ...
    	                  "}\n"
    	                  "\n"
    	                  "define internal void @thunk.TestClass.BaseInterface2.undo.1(ptr %0, ptr %1) {\n"
    	                  "entry:\n"
    	                  "  %2 = ptrtoint ptr %1 to i64\n"
    	                  "  %3 = sub i64 %2, 24\n"
    	                  "  %4 = inttoptr i64 %3 to ptr\n"
    	                  "  call void @TestClass_F4undo(ptr %0, ptr %4)\n"
    	                  "  ret void\n"
    	                  "}\n");
    }
