...
namespace {
	...
	TEST_F(CodeGenTest, CGErrorHandler) {
        ...
        EXPECT_EQ(output, "define void @_F4func(ptr %0) {\n"
                        ...
                        "  %handle_err = alloca %error, align 8\n"
                        "  store ptr %handle_err, ptr %2, align 8\n"
                        "  %3 = load ptr, ptr %2, align 8\n"
                        "  %4 = getelementptr inbounds %error, ptr %3, i32 0, i32 0\n"
                        "  store i32 0, ptr %4, align 4\n"
                        "  %5 = getelementptr inbounds %error, ptr %3, i32 0, i32 1\n"
                        "  store ptr null, ptr %5, align 8\n"
                        "  %6 = getelementptr inbounds %error, ptr %3, i32 0, i32 2\n"
                        "  store ptr null, ptr %6, align 8\n"
                        "  br label %handle\n"
                        "\n"
                        "handle:                                           ; preds = %entry\n"
                        "  %7 = load ptr, ptr %2, align 8\n"
                        "  %8 = getelementptr inbounds %error, ptr %7, i32 0, i32 0\n"
    ...
    TEST_F(CodeGenTest, CGErrorFail0) {
        ...
        EXPECT_EQ(output, "\n"
                        ...
                        "\n"
                        "define void @_F8testFail(ptr %0) {\n"
                        "entry:\n"
                        "  %1 = alloca ptr, align 8\n"
                        "  store ptr %0, ptr %1, align 8\n"
                        "  %2 = load ptr, ptr %1, align 8\n"
                        "  %3 = getelementptr inbounds %error, ptr %2, i32 0, i32 0\n"
                        ...
                        "entry:\n"
                        "  %2 = alloca ptr, align 8\n"
                        "  %main_err = alloca %error, align 8\n"
                        "  store ptr %main_err, ptr %2, align 8\n"
                        "  %3 = load ptr, ptr %2, align 8\n"
                        "  %4 = getelementptr inbounds %error, ptr %3, i32 0, i32 0\n"
                        "  store i32 0, ptr %4, align 4\n"
                        "  %5 = getelementptr inbounds %error, ptr %3, i32 0, i32 1\n"
    ...
    TEST_F(CodeGenTest, CGErrorFail3) {
		...
		EXPECT_EQ(output, "\n"
                        ...
                        "  %1 = alloca ptr, align 8\n"
                        "  store ptr %0, ptr %1, align 8\n"
                        "  %err_msg = call ptr @malloc(i64 6)\n"
                        "  call void @llvm.memcpy.p0.p0.i64(ptr %err_msg, ptr @0, i64 5, i1 false)\n"
                        "  %err_msg_end = getelementptr i8, ptr %err_msg, i64 5\n"
                        "  store i8 0, ptr %err_msg_end, align 1\n"
                        "  %2 = load ptr, ptr %1, align 8\n"
                        "  %3 = getelementptr inbounds %error, ptr %2, i32 0, i32 1\n"
                        "  store ptr %err_msg, ptr %3, align 8\n"
    ...
    TEST_F(CodeGenTest, CGErrorFail4) {
        ...
        EXPECT_EQ(output, "\n%error = type { i32, ptr, ptr }\n"
                          ...
                          "@error = external constant %error\n"
                          "\n"
                          "define linkonce_odr ptr @TestStruct.init_ctor(ptr %0) {\n"
                          "entry:\n"
                          "  %1 = alloca ptr, align 8\n"
                          "  store ptr %0, ptr %1, align 8\n"
                          "  %2 = load ptr, ptr %1, align 8\n"
                          ...
                          "  %4 = load ptr, ptr %1, align 8\n"
                          "  %5 = getelementptr inbounds %error, ptr %4, i32 0, i32 2\n"
                          "  store ptr %3, ptr %5, align 8\n"
                          "  %6 = load ptr, ptr %1, align 8\n"
                          "  %7 = getelementptr inbounds %error, ptr %6, i32 0, i32 0\n"
