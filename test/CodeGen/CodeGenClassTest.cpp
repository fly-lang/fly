...
namespace {
	...
	TEST_F(CodeGenTest, CGClassStaticMethods) {
        ...
        EXPECT_EQ(output, "\n"
                          ...
                          "  call void @TestClass_F5loadA_i(ptr %3, ptr %5)\n"
                          "  ret void\n"
                          "}\n"
        );
    }
	...
	TEST_F(CodeGenTest, CGClassExtendsClass) {
	    ...
	    EXPECT_EQ(output, "\n"
					      ...
					      "  %6 = load %BaseClass, ptr %2, align 8\n"
					      "  %7 = getelementptr inbounds nuw %BaseClass, %BaseClass %6, i32 0, i32 0\n"
					      "  %8 = load ptr, %BaseClass %7, align 8\n"
					      "  %9 = getelementptr ptr, ptr %8, i64 1\n"
					      "  %10 = load ptr, ptr %9, align 8\n"
					      "  call void %10(ptr %3, %BaseClass %6)\n"
					      // delete a
					      "  call void @free(%BaseClass %6)\n"
					      "  ret void\n"
					      "}\n"
					      "\n"
					      "declare ptr @malloc(i64)\n"
