...
namespace {
	...
	TEST_F(CodeGenTest, CGClassOverrideDispatch) {
		...
		EXPECT_EQ(output, "\n"
					  ...
					  "@vtable.TestClass.BaseClass = constant [3 x ptr] [ptr inttoptr (i64 -8 to ptr), ptr @thunk.TestClass.BaseClass.run, ptr @BaseClass_F9BaseClass]\n"
					  "\n"
					  "define linkonce_odr ptr @BaseClass.init_ctor(ptr %0) {\n"
					  "entry:\n"
					  "  %1 = alloca ptr, align 8\n"
					  ...
					  "  %4 = getelementptr inbounds %TestClass, ptr %2, i32 0, i32 1\n"
					  "  %5 = call ptr @BaseClass.init_ctor(ptr %4)\n"
					  "  %6 = getelementptr inbounds nuw %BaseClass, ptr %4, i32 0, i32 0\n"
					  "  store ptr @vtable.TestClass.BaseClass, ptr %6, align 8\n"
					  "  ret ptr %2\n"
					  "}\n"
					  "\n"
					  ...
					  "define internal void @thunk.TestClass.BaseClass.run(ptr %0, ptr %1) {\n"
					  "entry:\n"
					  "  %2 = ptrtoint ptr %1 to i64\n"
					  "  %3 = sub i64 %2, 8\n"
					  "  %4 = inttoptr i64 %3 to ptr\n"
