...
TEST_F(CodeGenTest, CGStructAssignVar) {
	...
	TEST_F(CodeGenTest, CGClassAttributes) {
        ...
        EXPECT_EQ(output, "\n"
						  "%error = type { i8, i32, i8* }\n"
						  "%TestClass_vtable = type { i32, void (%error*, %TestClass*)* }\n"
						  ...
						  "  store %TestClass_vtable* @TestClass_vtable, %TestClass_vtable** %3, align 8\n"
    ...
    TEST_F(CodeGenTest, CGClassGetterMethod) {
        ...
        EXPECT_EQ(output, "\n"
						  "%error = type { i8, i32, i8* }\n"
                          "%TestClass_vtable = type { i32, void (%error*, %TestClass*)*, i32 (%error*, %TestClass*)* }\n"
                          "%TestClass = type { %TestClass_vtable*, i32 }\n"
                          "\n"
                          "@error = external constant %error\n"
						  ...
						  "  %11 = getelementptr inbounds %TestClass_vtable, %TestClass_vtable* %10, i32 0, i32 2\n"
	...
	TEST_F(CodeGenTest, CGClassSetterMethod) {
        ...
        EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
						  "%TestClass_vtable = type { i32, void (%error*, %TestClass*)*, void (%error*, %TestClass*, i32)* }\n"
                          "%TestClass = type { %TestClass_vtable*, i32 }\n"
                          "\n"
                          "@error = external constant %error\n"
                          "@TestClass_vtable = constant %TestClass_vtable { i32 0, void (%error*, %TestClass*)* @TestClass_F9TestClass, void (%error*, %TestClass*, i32)* @TestClass_F4setA_i }\n"
                          "\n"
						  "define void @_F4func(%error* %0) {\n"
						  "entry:\n"
						  "  %1 = alloca %error*, align 8\n"
						  ...
						  "  %9 = load %TestClass_vtable*, %TestClass_vtable** %8, align 8\n"
						  "  %10 = getelementptr inbounds %TestClass_vtable, %TestClass_vtable* %9, i32 0, i32 2\n"
						  "  %11 = load void (%error*, %TestClass*, i32)*, void (%error*, %TestClass*, i32)** %10, align 8\n"
						  "  call void %11(%error* %3, %TestClass* %7, i32 1)\n"
						  // delete test
	...
	TEST_F(CodeGenTest, CGClassConstructorCallMethod) {
        ...
        EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
                          ...
                          "\n"
						  "@error = external constant %error\n"
						  "@TestClass_vtable = constant %TestClass_vtable { i32 0, void (%error*, %TestClass*)* @TestClass_F9TestClass, i32 (%error*, %TestClass*)* @TestClass_F1a }\n"
                          "\n"
                          "define void @_F4func(%error* %0) {\n"
						  "entry:\n"
						  "  %1 = alloca %error*, align 8\n"
	...
	TEST_F(CodeGenTest, CGClassStaticAttributes) {
        ...
        EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
						  ...
						  "  store i32 0, %TestClass_vtable** %4, align 4\n"
						  "  ret %TestClass* %2\n"
						  "}\n"
						  "\n"
                          "define void @TestClass_F9TestClass(%error* %0, %TestClass* %1) {\n"
	...
	TEST_F(CodeGenTest, CGClassStaticMethods) {
        ...
        EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
                          ...
                          "\n"
						  "@error = external constant %error\n"
						  "@TestClass_vtable = constant %TestClass_vtable { i32 0, void (%error*, %TestClass*)* @TestClass_F9TestClass, i32 (%error*)* @TestClass_F2do }\n"
						  "\n"
                          "define void @_F4func(%error* %0) {\n"
						  "entry:\n"
						  "  %1 = alloca %error*, align 8\n"
	...
	TEST_F(CodeGenTest, CGStructExtendsStruct) {
    	...
    	EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
						  ...
						  "  %2 = load %TestStruct*, %TestStruct** %1, align 8\n"
						  "  %3 = getelementptr inbounds %TestStruct, %TestStruct* %2, i32 0, i32 0\n"
						  "  %4 = call %BaseStruct* @BaseStruct.init_ctor(%BaseStruct* %3)\n"
	...
	TEST_F(CodeGenTest, CGStructExtendsStructs) {
    	...
    	EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
						  ...
						  "  %4 = call %BaseStruct* @BaseStruct.init_ctor(%BaseStruct* %3)\n"
						  "  %5 = getelementptr inbounds %TestStruct, %TestStruct* %2, i32 0, i32 1\n"
						  "  %6 = call %BaseStruct2* @BaseStruct2.init_ctor(%BaseStruct2* %5)\n"
						  "  %7 = getelementptr inbounds %TestStruct, %TestStruct* %2, i32 0, i32 2\n"
						  "  store i32 0, i32* %7, align 4\n"
						  "  %8 = getelementptr inbounds %TestStruct, %TestStruct* %2, i32 0, i32 3\n"
	...
	TEST_F(CodeGenTest, CGClassExtendsStruct) {
    	...
    	EXPECT_EQ(output, "\n"
						  ...
						  "  store %TestClass_vtable* @TestClass_vtable, %TestClass_vtable** %3, align 8\n"
						  "  %4 = getelementptr inbounds %TestClass, %TestClass* %2, i32 0, i32 1\n"
						  "  %5 = call %BaseStruct* @BaseStruct.init_ctor(%BaseStruct* %4)\n"
	...
	TEST_F(CodeGenTest, CGClassExtendsStructs) {
    	...
    	EXPECT_EQ(output, "\n%error = type { i8, i32, i8* }\n"
						  ...
						  "  %5 = call %BaseStruct* @BaseStruct.init_ctor(%BaseStruct* %4)\n"
						  "  %6 = getelementptr inbounds %TestClass, %TestClass* %2, i32 0, i32 2\n"
						  "  %7 = call %BaseStruct2* @BaseStruct2.init_ctor(%BaseStruct2* %6)\n"
	...
	TEST_F(CodeGenTest, CGClassExtendsClass) {
	    ...
	    EXPECT_EQ(output, "\n"
						  ...
						  "  store %BaseClass_vtable* @BaseClass_vtable, %BaseClass_vtable** %3, align 8\n"
    ...
    TEST_F(CodeGenTest, CGClassExtendsClasses) {
    	...
    	EXPECT_EQ(output, "\n"
    					  "%error = type { i8, i32, i8* }\n"
    					  "%BaseClass2_vtable = type { i32, void (%error*, %BaseClass2*)*, void (%error*, %BaseClass2*)*, void (%error*, %BaseClass2*)* }\n"
						  ...
						  "\n"
						  "@error = external constant %error\n"
						  "@BaseClass2_vtable = constant %BaseClass2_vtable { i32 0, void (%error*, %BaseClass2*)* @BaseClass2_F10BaseClass2, void (%error*, %BaseClass2*)* @BaseClass2_F2do, void (%error*, %BaseClass2*)* @BaseClass2_F4undo }\n"
						  "@BaseClass_vtable = constant %BaseClass_vtable { i32 0, void (%error*, %BaseClass*)* @BaseClass_F9BaseClass, void (%error*, %BaseClass*)* @BaseClass_F2do }\n"
						  "@TestClass_vtable = constant %TestClass_vtable { i32 0, void (%error*, %TestClass*)* @TestClass_F9TestClass, void (%error*, %TestClass*)* @TestClass_F3foo }\n"
						  "\n"
						  ...
						  "  store %BaseClass2_vtable* @BaseClass2_vtable, %BaseClass2_vtable** %3, align 8\n"
						  ...
						  "  %9 = getelementptr inbounds %BaseClass_vtable, %BaseClass_vtable* %8, i32 0, i32 2\n"
						  "  %10 = load void (%error*, %BaseClass*)*, void (%error*, %BaseClass*)** %9, align 8\n"
						  "  call void %10(%error* %4, %BaseClass* %6)\n"
						  "  ret void\n"
						  "}\n"
						  );
    }
