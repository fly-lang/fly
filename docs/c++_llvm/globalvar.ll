...
@t = dso_local global %struct.Test* null, align 8
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_globalvar.cpp, i8* null }]

; Function Attrs: noinline uwtable
define internal void @__cxx_global_var_init() #0 section ".text.startup" {
  %1 = call noalias nonnull i8* @_Znwm(i64 4) #4
  %2 = bitcast i8* %1 to %struct.Test*
  %3 = bitcast %struct.Test* %2 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %3, i8 0, i64 4, i1 false)
  call void @_ZN4TestC2Ev(%struct.Test* %2) #5
  store %struct.Test* %2, %struct.Test** @t, align 8
  ret void
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_globalvar.cpp() #0 section ".text.startup" {
