...
define dso_local i32 @main() #0 {
  ...
  %4 = call noalias nonnull i8* @_Znwm(i64 8) #4
  ...
  call void @_ZN4TestC2Ev(%struct.Test* %5) #5
  store %struct.Test* %5, %struct.Test** %2, align 8
  ...
  %11 = getelementptr inbounds %struct.Test, %struct.Test* %10, i32 0, i32 1
...
define linkonce_odr dso_local void @_ZN4TestC2Ev(%struct.Test* %0) unnamed_addr #3 comdat align 2 {
  %2 = alloca %struct.Test*, align 8
