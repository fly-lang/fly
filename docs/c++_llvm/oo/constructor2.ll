...
define dso_local i32 @main() #0 {
  ...
  %4 = call noalias nonnull i8* @_Znwm(i64 4) #4
  %5 = bitcast i8* %4 to %class.Test*
  %6 = bitcast %class.Test* %5 to i8*
  call void @llvm.memset.p0i8.i64(i8* align 4 %6, i8 0, i64 4, i1 false)
  call void @_ZN4TestC2Ev(%class.Test* %5) #5
  store %class.Test* %5, %class.Test** %2, align 8
  %7 = load %class.Test*, %class.Test** %2, align 8
  %8 = getelementptr inbounds %class.Test, %class.Test* %7, i32 0, i32 0
