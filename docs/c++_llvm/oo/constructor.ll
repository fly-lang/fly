...
define dso_local i32 @main() #0 personality i8* bitcast (i32 (...)* @__gxx_personality_v0 to i8*) {
  ...
  %5 = call noalias nonnull i8* @_Znwm(i64 1) #4
  %6 = bitcast i8* %5 to %class.Test*
  invoke void @_ZN4TestC2Ev(%class.Test* %6)
...
define linkonce_odr dso_local void @_ZN4TestC2Ev(%class.Test* %0) unnamed_addr #2 comdat align 2 {
  %2 = alloca %class.Test*, align 8
